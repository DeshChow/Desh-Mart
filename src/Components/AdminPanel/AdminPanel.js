            ...
            <div className='container'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <fieldset onChange={onChangeValue}>
                       ...
                       <label for="womensdress"> <input type="radio" value="womensdress" name="p" />Women Dress Product</label>
                       <label for="electronics"> <input type="radio" value="electronics" name="p" />Electronics</label>
